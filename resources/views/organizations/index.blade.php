    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                @include('common.header-text',['sectiontext' => 'Organizations List'])
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">View Organizations</li>
                    </ol>
                ...
                <div class="card">
                    <div class="card-body pb-0">
                        ...
                        <div class="row mb-2" style="border-bottom: 1px solid #dee2e6;">
                            <div class="col-md-8">
                            <ul class="nav nav-tabs customtab2 mt-2 border-bottom-0 font-14 tab-hash tab-ajax"role="tablist" data-href="organizations/get" data-method="get" data-default-tab="tab_20">
                            ...
                            <div class="col-md-4">
                                @if(\App\Helpers\Helper::CheckPermission(null,'organization','add') || Auth::user()->IsAdmin)
                                    <a
                                            href="organization/edit/{!! Crypt::encrypt(0) !!}"
