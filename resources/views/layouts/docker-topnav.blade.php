    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="index.html">
                <!-- Logo icon --><b>
                    ...
                    <!-- Dark Logo icon -->
                    <img src="{!! URL::to('/assets/images/custom/logo-icon.png') !!}" alt="homepage" class="dark-logo">
                    <!-- Light Logo icon -->
                    <img src="{!! URL::to('/assets/images/custom/logo-light-icon.png') !!}" alt="homepage" class="light-logo">
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
                <span style="">
                         <!-- dark Logo text -->
                         <img src="{!! URL::to('/assets/images/custom/logo-text.png') !!}" alt="homepage" class="dark-logo">
                    <!-- Light Logo text -->
                         <img src="{!! URL::to('/assets/images/custom/logo-light-text.png') !!}" class="light-logo" alt="homepage">
                </span>
            </a>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav mr-auto">
                <!-- This is  -->
                <li class="nav-item"><a class="nav-link sidebartoggler nav-toggler d-block d-md-none waves-effect waves-dark"
                ...
                <li class="nav-item dropdown u-pro">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href=""
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><!--<img
                                src="" alt="user" class="pp_img"> --><span class="hidden-md-down">{{ Auth::user()->FullName }} &nbsp;<i
                                    class="fa fa-angle-down"></i></span> </a>
                    <div class="dropdown-menu dropdown-menu-right animated "> <!-- flipInY-->
                        <!-- text-->
                        <a href="/profile/{!! Crypt::encrypt(Auth::id()) !!}" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                        <!--
                        ...
                        @if(\App\Helpers\Helper::CheckPermission('settings','users','view') || Auth::user()->IsAdmin)
                            <a href="{!! URL::to('/users') !!}" class="dropdown-item"><i class="ti-settings"></i> Setting</a>
                            <div class="dropdown-divider"></div>
                        @endif
                        <a href="{!! URL::to('/logout') !!}" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                        <!-- text-->
                    </div>
                </li>
                <!-- ============================================================== -->
        ...
        $('.sidebartoggler').on('click',function () {
            setTimeout(function () {
                if($("body").hasClass("mini-sidebar")){
                    console.log('yes has')
                    //$('.light-logo').css({'height':'69px'});
                }else{
                    console.log('not at all')
                    //$('.light-logo').css({'height':'75px'});
                }
            },100)
