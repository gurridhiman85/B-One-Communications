    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                @include('common.header-text',['sectiontext' => 'Departments List'])
            </div>
                ...
                <div class="card">
                    <div class="card-body pb-0">
                        ...
                        <div class="row mb-2" style="border-bottom: 1px solid #dee2e6;">
                            <div class="col-md-8">
                                <ul class="nav nav-tabs customtab2 mt-2 border-bottom-0 font-14 tab-hash tab-ajax"role="tablist" data-href="departments/get" data-method="get" data-default-tab="tab_20">
                            ...
                            <div class="col-md-4">
                                @if(\App\Helpers\Helper::CheckPermission(null,'department','add') || Auth::user()->IsAdmin)
                                    <a
                                            href="department/edit/{!! Crypt::encrypt(0) !!}"
