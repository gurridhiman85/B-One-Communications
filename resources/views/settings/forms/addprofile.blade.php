<?php
$n = isset($profile) && !empty($profile) ? false : true;
?>
<div class="card">
    <div class="form-body">
        <div class="card-body">
            <form class="ajax-Form" enctype="multipart/form-data" method="post" action="settings/addprofile">
                {!! csrf_field() !!}
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="profile_name" name="profile_name"
                                   ...
                                   placeholder="" value="<?= (!$n) ? $profile->profile_name : ''; ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                        ...
                        <div class="custom-control custom-checkbox mr-sm-2 mb-3">
                            <input type="checkbox" name="is_active" class="custom-control-input" id="checkbox0" value="1" <?= (!$n && isset($profile) && $profile->is_active == 1) ? 'checked' : ''; ?>>
                ...
                <div class="form-actions pull-right">
                    <input type="hidden" name="profile_id" value="<?= (!$n) ? $profile->profile_id : '0'; ?>">
                    <input type="hidden" name="id" value="<?= (!$n) ? $profile->id : '0'; ?>">
